let posts = [
    ...
    avatar: "images/users/avatar-vangogh.jpg",
    post: "images/feed/post-vangogh.jpg",
    ...
    },
    {
        ...
        avatar: "images/users/avatar-courbet.jpg",
        post: "images/feed/post-courbet.jpg",
        ...
        avatar: "images/users/avatar-ducreux.jpg",
        post: "images/feed/post-ducreux.jpg",
...
function likes(id){
    ...
    // get the id number
    const idNumber = Number(id.slice(-1))
    
    // update posts array
    posts[idNumber].likes ++
            ...
            <section>
                <div class="container">
                    <div class="post-header">
                        <img class="post-user-img" src="${arr[i].avatar}" alt="">
                        <div>
                            <h3>${arr[i].name}</h3>
                            <p>${arr[i].location}</p>
                        </div>
                    ...
                    <img class="post-feed-img" src="${arr[i].post}" alt="">
                    
                    <div class="post-footer">
                        <ul class="icons-list">
                            <li>
                                <button id="like-btn-${i}" onclick="likes(this.id)">
                        ...
                        <p><span class="bold">${arr[i].likes} likes</span></p>
                        <p class="post-comment"><span class="bold">${arr[i].username}</span> ${arr[i].comment}</p>
                    </div>
                </div>
            </section> `
    }
